...
// $instance = new stream_player_loader($args);				// instantiates loader class
// (ie. search and replace 'stream_player_' with 'my_plugin_' function namespace)
...
if ( !class_exists( 'stream_player_loader' ) ) {
	...
	class stream_player_loader {
		...
		public function notice_boxer() {
			...
			if ( isset( $GLOBALS['stream_player_data']['load']['notices'] ) && $GLOBALS['stream_player_data']['load']['notices'] ) {
				return;
			}
...
add_action( 'plugins_loaded', 'stream_player_load_prefixed_functions', 0 );

if ( !function_exists( 'stream_player_load_prefixed_functions' ) ) {
	function stream_player_load_prefixed_functions() {
		...
		if ( !function_exists( 'stream_player_get_namespace_from_function' ) ) {
			function stream_player_get_namespace_from_function( $f ) {
		...
		if ( !function_exists( 'stream_player_loader_instance' ) ) {
			function stream_player_loader_instance() {
				$namespace = stream_player_get_namespace_from_function( __FUNCTION__ );
		...
		if ( !function_exists( 'stream_player_freemius_instance' ) ) {
			function stream_player_freemius_instance() {
				$namespace = stream_player_get_namespace_from_function( __FUNCTION__ );
		...
		if ( !function_exists( 'stream_player_plugin_data' ) ) {
			function stream_player_plugin_data() {
				$namespace = stream_player_get_namespace_from_function( __FUNCTION__ );
		...
		if ( !function_exists( 'stream_player_plugin_version' ) ) {
			function stream_player_plugin_version() {
				$namespace = stream_player_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Set Pro Namespace
		// -----------------
		if ( !function_exists( 'stream_player_pro_namespace' ) ) {
			function stream_player_pro_namespace( $pronamespace ) {
				$namespace = stream_player_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Add Settings
		// ------------
		if ( !function_exists( 'stream_player_add_settings' ) ) {
			function stream_player_add_settings() {
				$namespace = stream_player_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Get Defaults
		// ------------
		if ( !function_exists( 'stream_player_default_settings' ) ) {
			function stream_player_default_settings( $key = false ) {
				$namespace = stream_player_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Get Options
		// -----------
		if ( !function_exists( 'stream_player_get_options' ) ) {
			function stream_player_get_options() {
				$namespace = stream_player_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		if ( !function_exists( 'stream_player_get_setting' ) ) {
			function stream_player_get_setting( $key, $filter = true ) {
				$namespace = stream_player_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		if ( !function_exists( 'stream_player_get_settings' ) ) {
			function stream_player_get_settings( $filter = true ) {
				$namespace = stream_player_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Reset Settings
		// --------------
		if ( !function_exists( 'stream_player_reset_settings' ) ) {
			function stream_player_reset_settings() {
				$namespace = stream_player_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Update Settings
		// ---------------
		if ( !function_exists( 'stream_player_update_settings' ) ) {
			function stream_player_update_settings() {
				$namespace = stream_player_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Delete Settings
		// ---------------
		if ( !function_exists( 'stream_player_delete_settings' ) ) {
			function stream_player_delete_settings() {
				$namespace = stream_player_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Message Box
		// -----------
		if ( !function_exists( 'stream_player_message_box' ) ) {
			function stream_player_message_box( $message, $echo = false ) {
				$namespace = stream_player_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Settings Header
		// ---------------
		if ( !function_exists( 'stream_player_settings_header' ) ) {
			function stream_player_settings_header() {
				$namespace = stream_player_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Settings Page
		// -------------
		if ( !function_exists( 'stream_player_settings_page' ) ) {
			function stream_player_settings_page() {
				$namespace = stream_player_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		if ( !function_exists( 'stream_player_settings_table' ) ) {
			function stream_player_settings_table() {
				$namespace = stream_player_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		if ( !function_exists( 'stream_player_settings_row' ) ) {
			function stream_player_settings_row( $option, $setting ) {
				$namespace = stream_player_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		if ( !function_exists( 'stream_player_settings_resources' ) ) {
			function stream_player_settings_resources( $media, $color_picker ) {
				$namespace = stream_player_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
